...
const Footer: React.FC = () => {
    ...
    return (
        <div className="Footer">
            <div className="footer-content" style={{ flexDirection: isSmallScreen ? "column" : "row" }}>
                ...
                <div className="footer-links" style={{ width: isSmallScreen ? "100%" : "70%", float: isSmallScreen ? "none" : "right" }}>
                    <ul>
            ...
            <div className="footer-copyright">
                <p>© 2024 Todos Somos Especiais. Desenvolvido com <span role="img" aria-label="heart">❤️</span> por André Ferreira</p>
            </div>
        </div>
    );
}
